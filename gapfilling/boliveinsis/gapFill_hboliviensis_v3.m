function gapFill_hboliviensis_v3
...
database = removeRxns(database,{'BIOMASS_low salinity '}); % solo dejamos 1 ec biomasa
...
% read template file from metadraft
draft = readCbModel('G:\My Drive\Magister\Metadraft\v2\h_bol_lc1.xml','fileType','SBML');% los mets y lo cambia por _e
%draft = h_bol_lc1;
...
modelGapfilled.rxns(getPosOfElementsInArray({'BIOMASS_high salinity '},modelGapfilled.rxns)) ={'BIOMASS_high_salinity'};
save('modelGapfilled_001_wp','modelGapfilled')
...
xlswrite('gap_filling_v1_001_wp',info_added,'added')
xlswrite('gap_filling_v1_001_wp',info_full,'full_model')
xlswrite('gap_filling_v1_001_wp',info_solution,'solution')
xlswrite('gap_filling_v1_001_wp',gene_associatios,'gene_asso')
xlswrite('gap_filling_v1_001_wp',info_media,'media')
...
save('modelGapfilled_01','modelGapfilled')
% model_gapfilled = removeRxns(database, translatedSolutions{1});
...
xlswrite('gap_filling_v1_08',info_added,'added')
xlswrite('gap_filling_v1_08',info_full,'full_model')
xlswrite('gap_filling_v1_08',info_solution,'solution')
xlswrite('gap_filling_v1_08',gene_associatios,'gene_asso')
xlswrite('gap_filling_v1_08',info_media,'media')
...
save('modelGapfilled_1','modelGapfilled')
...
xlswrite('gap_filling_v1_1',info_added,'added')
xlswrite('gap_filling_v1_1',info_full,'full_model')
xlswrite('gap_filling_v1_1',info_solution,'solution')
xlswrite('gap_filling_v1_1',gene_associatios,'gene_asso')
xlswrite('gap_filling_v1_1',info_media,'media')
...
save('modelGapfilled_001','modelGapfilled')
...
xlswrite('gap_filling_v1_001',info_added,'added')
xlswrite('gap_filling_v1_001',info_full,'full_model')
xlswrite('gap_filling_v1_001',info_solution,'solution')
xlswrite('gap_filling_v1_001',gene_associatios,'gene_asso')
xlswrite('gap_filling_v1_001',info_media,'media')
