...
draft = readCbModel('G:\My Drive\Magister\Metadraft\v2\h_asl9.xml','fileType','SBML');% los mets y lo cambia por _e
%draft = h_bol_lc1;
...
save('modelGapfilled_001_wp_asl10','modelGapfilled')
...
xlswrite('gap_filling_v1_001_wp_asl10',info_added,'added')
xlswrite('gap_filling_v1_001_wp_asl10',info_full,'full_model')
xlswrite('gap_filling_v1_001_wp_asl10',info_solution,'solution')
xlswrite('gap_filling_v1_001_wp_asl10',gene_associatios,'gene_asso')
xlswrite('gap_filling_v1_001_wp_asl10',info_media,'media')
...
xlswrite('gap_filling_v1_08_asl10',info_added,'added')
xlswrite('gap_filling_v1_08_asl10',info_full,'full_model')
xlswrite('gap_filling_v1_08_asl10',info_solution,'solution')
xlswrite('gap_filling_v1_08_asl10',gene_associatios,'gene_asso')
xlswrite('gap_filling_v1_08_asl10',info_media,'media')
...
xlswrite('gap_filling_v1_1_asl10',info_added,'added')
xlswrite('gap_filling_v1_1_asl10',info_full,'full_model')
xlswrite('gap_filling_v1_1_asl10',info_solution,'solution')
xlswrite('gap_filling_v1_1_asl10',gene_associatios,'gene_asso')
xlswrite('gap_filling_v1_1_asl10',info_media,'media')
...
xlswrite('gap_filling_v1_001_asl10',info_added,'added')
xlswrite('gap_filling_v1_001_asl10',info_full,'full_model')
xlswrite('gap_filling_v1_001_asl10',info_solution,'solution')
xlswrite('gap_filling_v1_001_asl10',gene_associatios,'gene_asso')
xlswrite('gap_filling_v1_001_asl10',info_media,'media')
